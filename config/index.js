...
module.exports = {
  dev: {
    // Paths
    assetsSubDirectory: 'video',
    assetsPublicPath: '/',
    proxyTable: {
      '/boot-pub-survey-video': {
        // target: 'http://192.168.1.69:18081',      // 志猛个人服务器
        // target: 'http://192.168.1.137:80',      // 和鹏个人服务器
  ...
  build: {
    ...
    // Gzip off by default as many popular ieVideo hosts such as
    // Surge or Netlify already gzip all ieVideo images for you.
